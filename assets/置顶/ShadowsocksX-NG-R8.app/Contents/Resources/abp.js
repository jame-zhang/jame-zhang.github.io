<link rel="stylesheet" class="aplayer-secondary-style-marker" href="/assets/css/APlayer.min.css"><script src="/assets/js/APlayer.min.js" class="aplayer-secondary-script-marker"></script><script class="meting-secondary-script-marker" src="/assets/js/Meting.min.js"></script>// Generated by gfwlist2pac in precise mode
...
extend(ActiveFilter, Filter, {
       ...
       {
       if (this.domains[domain] && domain != docDomain && (domain.length <= docdomain.length="" ||="" domain.indexof("."="" +="" docdomain)="" !="domain.length" -="" 1))="" {="" return="" false;="" }="" true;="" });="" function="" regexpfilter(text,="" regexpsource,="" contenttype,="" matchcase,="" domains,="" thirdparty,="" sitekeys)="" activefilter.call(this,="" text,="" sitekeys);="" if="" (contenttype="" this.contenttype="contentType;" (matchcase)="" this.matchcase="matchCase;" (thirdparty="" this.thirdparty="thirdParty;" (sitekeys="" this.sitekeysource="sitekeys;" (regexpsource.length="">= 2 && regexpSource[0] == "/" && regexpSource[regexpSource.length - 1] == "/")
  {
...
remove: function(filter)
  {
    ...
    if (list.length <= 1)="" {="" delete="" this.filterbykeyword[keyword];="" }="" else="" var="" index="list.indexOf(filter);" if="" (index="">= 0)
      {
        list.splice(index, 1);
        if (list.length == 1)
        {
